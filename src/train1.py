...
def main():
    ...
    with open(OUT_DIR + '/' + '__a.pickle', 'wb') as f:
        pickle.dump(a_p, f)

    with open(OUT_DIR + '/' + '__b.pickle', 'wb') as f:
        pickle.dump(b_ut, f)

    with open(OUT_DIR + '/' + '__c.pickle', 'wb') as f:
        pickle.dump(c_i, f)

    with open(OUT_DIR + '/' + '__d.pickle', 'wb') as f:
        pickle.dump(d_u, f)
